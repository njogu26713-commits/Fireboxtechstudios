  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-white/60">Comprehensive technology solutions designed to scale, secure, and accelerate your business.</p>
      </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/10">
                  {service.pricing && (
                    <span className="font-mono font-bold text-white/80">{service.pricing}</span>
                  )}
